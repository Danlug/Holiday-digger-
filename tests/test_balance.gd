...
func _test_fall_damage(bal) -> void:
	...
	_check("падение 5 клеток", bal.get_fall_damage(5.0), 5.0, 0.3)
	_check("падение 8 клеток", bal.get_fall_damage(8.0), 14.0, 0.5)
	_check("падение 10 клеток", bal.get_fall_damage(10.0), 22.0, 0.5)
	_check("падение 15 клеток", bal.get_fall_damage(15.0), 54.0, 1.0)
	_check("падение 20 клеток", bal.get_fall_damage(20.0), 100.0, 1.0)
	_check("падение 25 клеток", bal.get_fall_damage(25.0), 160.0, 1.5)
	_check("падение 30 клеток", bal.get_fall_damage(30.0), 233.0, 1.5)
