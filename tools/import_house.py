...
# Докуда брать рисунок по высоте: по полу навеса, где колёса машины касаются
# 0.68 — пол навеса, где стоит машина; ниже начинается горизонтальная мостовая, которой в плоском виде сбоку не
# место (см. комментарий к обрезке).
BOTTOM_FRACTION = 0.68
PALETTE_COLORS = 48
...
def main() -> None:
    ...
    #
    # Нижняя треть рисунка — мостовая, газон и забор, показанные сверху, в
